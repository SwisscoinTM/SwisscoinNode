...
static const int64_t MAX_MONEY = 9200000000000000000;
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const unsigned int LOCKTIME_THRESHOLD = 900000000; // Tue Nov  5 00:53:20 1985 UTC
...
inline int64_t FutureDrift(int64_t nTime, int nHeight) { return FutureDriftV1(nTime); }
